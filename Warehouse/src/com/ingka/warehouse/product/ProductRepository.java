...
public class ProductRepository {
        ...
        private static File PRODUCTS_JSON = new File("/home/rano/code/ranokuhl/JavaPrograms/Warehouse/libs/products.json");
    ...
    //        System.out.println(products.getProducts().get(1).toString());
    //
    //        System.out.println(products.getProducts().get(1).getName());
//            listProducts();
//            getIdxProduct();
            removeProduct();
        }
...
//            System.out.println(array.get(1).get("name").asInt());
            ...
            String resultUpdate = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(array);
            ...
            JsonGenerator generator = factory.createGenerator(
                    new File("/home/rano/jsonoutput/infoOne.json"), JsonEncoding.UTF8);
